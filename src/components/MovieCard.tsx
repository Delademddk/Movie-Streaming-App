...
export default function MovieCard({ movie }: MovieCardProps) {
  ...
  return (
    <div 
      ...
      onClick={handleClick}   // ← Only this changed
    >
      {/* Poster Container - EXACTLY your original code */}
      <div className="relative w-full max-w-55 p-4 rounded-xl overflow-hidden bg-[#0F2026] border border-white/10 hover:border-white/20 transition">
        ...
        {/* Rating Badge - EXACTLY your original code */}
      ...
      {/* Info below poster - EXACTLY your original code */}
