...
export default function NavBar() {
  return (
    <header className="w-full bg-[#1E293B] px-4 md:px-6 py-3 md:py-4 flex items-center justify-between gap-4 relative">
      {/* LEFT SIDE */}
      <div className="flex items-center min-w-0">
        ...
        <div className="hidden md:flex items-center text-xs max-md:text-xs lg:text-[14px] gap-3 md:gap-4 lg:gap-6 px-3 md:px-4 lg:px-8">
          <a
            href="#"
            className="cursor-pointer  hover:text-white transition-colors text-[#94A3B8]"
          >
            Home
          </a>
          <a
